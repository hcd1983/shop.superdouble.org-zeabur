...
if ( !class_exists( 'WDS_Taxonomy_Radio' ) ) {
  ...
  // $custom_tax_mb = new WDS_Taxonomy_Radio( 'product_cate' );
   $custom_tax_mb = new WDS_Taxonomy_Radio( 'mycoupon_cate' );
   $custom_tax_mb->priority	="default"; 
   $custom_tax_mb->post_types=array("mycoupon");
