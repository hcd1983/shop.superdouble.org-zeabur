...
foreach ($posts as $key => $post_id) {
	...
	$ProductsInfo["staging"]= get_field('staging', $post_id );
	$ProductsInfo["combine_image"]= get_field('combine_image', $post_id );
	$ProductsInfo["combine_type"]= get_field('combine_type', $post_id );
	$ProductsInfo['part_number'] = get_field('partNumber', $post_id);
	$ProductsInfo['preorder'] = $ProductsInfo['preorder'] === '1' ? true : false;
	
	if($ProductsInfo["onsale"] == 1 && $ProductsInfo["saleprice"] && $ProductsInfo["saleprice"] < $ProductsInfo["price"]){
        $ProductsInfo["delprice"] = $ProductsInfo["price"];
    }
