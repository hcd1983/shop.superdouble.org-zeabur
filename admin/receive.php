...
$arr["ErrDesc"] = isset($_REQUEST['ErrDesc'])?$_REQUEST['ErrDesc']:""; //當  TranStatus為 F  時，將回傳錯誤訊息（失敗原因）於此

//分期信用卡
$arr["Installment"] = isset($_REQUEST['Installment'])?$_REQUEST['Installment']:"";


//虛擬帳戶 03 和 05 IBON
$arr["ATMNo"] = isset($_REQUEST['ATMNo'])?$_REQUEST['ATMNo']:"";//虛擬帳號號碼
$arr["IBONNO"] = isset($_REQUEST['IBONNO'])?$_REQUEST['IBONNO']:""; //ibon
$arr["BankCode"] = isset($_REQUEST['BankCode'])?$_REQUEST['BankCode']:""; //ibon
...
$arr["BarCode1"] = isset($_REQUEST['BarCode1'])?$_REQUEST['BarCode1']:"";//虛擬帳號號碼
$arr["BarCode2"] = isset($_REQUEST['BarCode2'])?$_REQUEST['BarCode2']:"";//虛擬帳號號碼
$arr["BarCode3"] = isset($_REQUEST['BarCode3'])?$_REQUEST['BarCode3']:"";//虛擬帳號號碼
...
//只回傳一個
if( is_string($arr["OrderNo"]) || (is_array($arr["OrderNo"]) && count($arr["OrderNo"]) == 1 ) ):
